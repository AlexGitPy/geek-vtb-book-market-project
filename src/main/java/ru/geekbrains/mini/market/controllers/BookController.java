...
public class BookController {
    ...
    //GET http://localhost:8181/market/api/v1/books/1
    @GetMapping("/{id}")
    ...
    //POST http://localhost:8181/market/api/v1/books/
    @PostMapping
    ...
    //PUT http://localhost:8181/market/api/v1/books/
    @PutMapping
    ...
    //DELETE http://localhost:8181/market/api/v1/books/1
    @DeleteMapping("/{id}")
